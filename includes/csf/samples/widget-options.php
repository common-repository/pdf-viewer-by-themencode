...
// Create a widget 1
//
PVFWOF::createWidget( 'pvfwof_widget_example_1', array(
  'title'       => 'Pvfwof Widget Example 1',
  'classname'   => 'pvfwof-widget-classname',
...
//
if ( ! function_exists( 'pvfwof_widget_example_1' ) ) {
  function pvfwof_widget_example_1( $args, $instance ) {
    ...
    echo '<h3>Pvfwof Widget Example 1</h3>';
...
// Create a widget 2
//
PVFWOF::createWidget( 'pvfwof_widget_example_2', array(
  'title'       => 'Pvfwof Widget Example 2',
  'classname'   => 'pvfwof-widget-classname',
...
// Attention: This function named considering above widget base id.
//
if ( ! function_exists( 'pvfwof_widget_example_2' ) ) {
  function pvfwof_widget_example_2( $args, $instance ) {
    ...
    echo '<div style="padding: 20px; background-color: #f7f7f7;">';
    echo '<h3>Pvfwof Widget Example 2</h3>';
    echo '<p><strong>Title:</strong> '. $instance['title'] .'</p>';
    echo '<p><strong>Text:</strong> '. $instance['opt-text'] .'</p>';
    echo '<p><strong>Color:</strong> '. $instance['opt-color'] .'</p>';
